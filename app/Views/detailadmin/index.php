...
<form action="<?= base_url('scientist/detail_proses')?>" method="post">
 ...
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo $scientist->tanggalLahir;?></td>
            </tr>
            <tr>
                <td width="200px"><p>Jenis Kelamin</p></td>
                <td>:</td>
                <td><?php echo $scientist->gender;?></td>
                
            </tr>
            <tr>
                <td width="200px"><p>Agama</p></td>
                <td>:</td>
                <td><?php echo $scientist->agama;?></td>
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo $scientist->email;?></td>
            </tr>
            <tr>
        ...
        <table align="center" width=1100px border="0" cellspacing="0" bgcolor="#F8F8FF">
            ...
            <td width="200px"><p>Tahun Masuk Kuliah</p></td>
                <td>:</td>
                <td><?php echo $scientist->tahun;?></td>
            </tr>
        ...
        <table align="center" width=1100px border="0" cellspacing="0" bgcolor="#F8F8FF">
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo $scientist->suketaktifk;?></td>
            </tr>
            <tr>
        ...
        <table align="center" width=1100px border="0" cellspacing="0" bgcolor="#F8F8FF">
            ...
            <tr>
                ...
                <td>:</td>
                <td><textarea cols="39" rows="3" placeholder="Berikan catatan kekurangan/kesalahan" required name="alamatku" value="<?php echo $scientist->catatan;?>"></textarea></td>
            </tr>
            <tr>
                <td width="200px"><p>Status</p></td>
                <td>:</td>
                <td><?php echo $scientist->status;?></td>
            </tr>
            <tr>
